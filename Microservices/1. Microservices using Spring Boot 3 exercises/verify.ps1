# PowerShell Script to run and verify Microservices using Spring Boot 3 exercises
...
Write-Output "Running Maven compilation and testing for all 10 submodules..."
...
Write-Output "`n=========================================================="
Write-Output "All 10 Spring Boot 3 Microservices Submodules compiled & tested successfully!"
Write-Output "=========================================================="
