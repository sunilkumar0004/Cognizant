# PowerShell Script to run and verify Microservices Load Balancing exercises
...
# Re-use parent/sibling Maven if already downloaded
...
Write-Output "Running Maven compilation and testing..."
...
Write-Output "`n=========================================================="
Write-Output "All Microservices Edge & Load Balancing Exercises verified!"
Write-Output "=========================================================="
